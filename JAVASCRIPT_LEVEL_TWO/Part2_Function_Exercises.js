...
function caught_speeding(speed, is_birthday) {
    ...
    if (speed > 80)
        ...
        ticket = 1
    return ticket * Number(!is_birthday)
}

// testing
console.log("5: ")
console.log(caught_speeding(60, 0))
console.log(caught_speeding(65, 0))
console.log(caught_speeding(90, 0))
console.log(caught_speeding(100, 1))
